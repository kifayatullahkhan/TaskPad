...
<title>User's Management (Online User Account Registration) |  Zorkif Taskpad</title>
<!-- InstanceEndEditable -->
...
<div class="wrapper col3">
  <div id="breadcrumb"><!-- InstanceBeginEditable name="ER_ConentPageLocation" -->
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="user_accounts_registration.php">تسجيل مستخد جديد </a></li>
...
<div class="wrapper col5">
  ...
  <div id="content">
  <?php require_once('include_code/user_accounts_registration.php'); ?>
