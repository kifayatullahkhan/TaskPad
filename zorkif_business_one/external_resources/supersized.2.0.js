				...
				if (options.navigation == 1){ //Skip if no navigation
					...
					$('#nextslide img').hover(function() {
						if($.paused == true) return false;
					   	$(this).attr("src", "images/gallery_images/forward.gif");
					}, function(){
						if($.paused == true) return false;
					    $(this).attr("src", "images/gallery_images/forward_dull.gif");
					});
					$('#prevslide img').hover(function() {
						if($.paused == true) return false; 
					    $(this).attr("src", "images/gallery_images/back.gif");
					}, function(){
						if($.paused == true) return false;
					    $(this).attr("src", "images/gallery_images/back_dull.gif");
					});
					
				    //Play/Pause Button
				    $('#pauseplay').click(function() {
				    	if($.inAnimation) return false;
				    	var src = ($(this).find('img').attr("src") === "images/gallery_images/play.gif") ? "images/gallery_images/pause.gif" : "images/gallery_images/play.gif";
      					if (src == "images/gallery_images/pause.gif"){
      						$(this).find('img').attr("src", "images/gallery_images/play.gif");
      						$.paused = false;
					        slideshow_interval = setInterval(nextslide, options.slide_interval);  
				        }else{
				        	$(this).find('img').attr("src", "images/gallery_images/pause.gif");
				        	clearInterval(slideshow_interval);
				        	$.paused = true;
				        }
				    ...
				    $('#pauseplay').mouseover(function() {
				    	var imagecheck = ($(this).find('img').attr("src") === "images/gallery_images/play_dull.gif");
				    	if (imagecheck){
      						$(this).find('img').attr("src", "images/gallery_imagesplay.gif"); 
				        }else{
				        	$(this).find('img').attr("src", "images/gallery_images/pause.gif");
				        }
				    });
				    ...
				    $('#pauseplay').mouseout(function() {
				    	var imagecheck = ($(this).find('img').attr("src") === "images/gallery_images/play.gif");
				    	if (imagecheck){
      						$(this).find('img').attr("src", "iimages/gallery_images/play_dull.gif"); 
				        }else{
				        	$(this).find('img').attr("src", "images/gallery_images/pause_dull.gif");
				        }
				        return false;
				    });
				}
		...
		$('#supersize > *').hover(function() {
	   		if (options.slideshow == 1 && options.pause_hover == 1){
	   			if(!($.paused) && options.navigation == 1){
	   				$('#pauseplay > img').attr("src", "images/gallery_images/pause.gif"); 
	   				clearInterval(slideshow_interval);
	   			}
	   		}
			...
			if (options.slideshow == 1 && options.pause_hover == 1){
				if(!($.paused) && options.navigation == 1){
					$('#pauseplay > img').attr("src", "images/gallery_images/pause_dull.gif");
					slideshow_interval = setInterval(nextslide, options.slide_interval);
				} 
			}
