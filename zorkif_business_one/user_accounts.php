...
<title>User's Management (Create User Account) |  Zorkif Taskpad</title>
...
<div class="wrapper col3">
  <div id="breadcrumb"><!-- InstanceBeginEditable name="ER_ConentPageLocation" -->
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="user_accounts.php">Create New User Account</a></li>
...
<div class="wrapper col5">
  ...
  <!-- InstanceBeginEditable name="ER_CONTENT1" -->
    <h1>&nbsp;</h1>
    <?php require_once("include_code/user_accounts.php"); ?>
