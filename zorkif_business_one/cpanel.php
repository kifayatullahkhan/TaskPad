...
<title>Control Panel |  Zorkif Taskpad</title>
<!-- InstanceEndEditable -->
...
<div class="wrapper col3">
  <div id="breadcrumb"><!-- InstanceBeginEditable name="ER_ConentPageLocation" -->
    <ul>
      <li class="first">روابط سريعة</li>
      <li> &#187;</li>
      <li><a href="cpanel.php">الرئيسية</a></li>
    </ul>
...
<div class="wrapper col5">
  ...
  <div id="content">
  <h3 id="why">لوحة التحكم </h3>

        <?php require_once('erp_include_code/cpanel_erp_code.php'); ?>
        <?php  require_once('include_code/cpanel_default_code.php'); ?>
   
  </div>
  <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="ER_CONTENT2" -->
  <?php require_once("include_code/CPanel_RIGHT_PANEL_DEFAULT.php");?>
  <!-- InstanceEndEditable -->
  <div class="clear"></div>
  </div>
</div>
