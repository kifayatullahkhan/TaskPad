...
if(isset($_POST['SearchUsername']) && $_POST['SearchUsername']!="") {
   $SearchUsername=" WHERE Username='" .$_POST['SearchUsername']  ."'";
}else	
	if(isset($_GET['SearchUsername']) && $_GET['SearchUsername']!="") {
	   $SearchUsername=" WHERE Username='" .$_GET['SearchUsername']  ."'";
	}
...
mysql_select_db($database_Conn, $Conn);
$query_rs_get_user_accounts = "SELECT * FROM user_accounts  $SearchUsername ORDER BY Username ASC";
    ...
    <table width="100%" align="center" cellpadding="5" cellspacing="5">
      ...
      <tr valign="baseline">
        ...
        <td width="25%" align="left"><span id="sprytextfield2">
          <input name="Password_new" type="password" id="Password_new" value="" size="33" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="left">&nbsp;</td>
      </tr>
      <tr valign="baseline">
        <td width="25%" align="right" nowrap="nowrap">&nbsp;</td>
        <td width="25%"><input type="submit" value="Change Password" />
...
<br />
Click on the Username to select it for &quot;<strong><i>Password Change</i></strong>&quot;.<br />
