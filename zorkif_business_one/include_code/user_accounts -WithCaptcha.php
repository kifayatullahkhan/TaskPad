...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	// Code for captica Script
 require_once('external_resources/recaptcha-php-1.11/recaptchalib.php');
...
?>
      ...
      <tr valign="baseline">
        <td align="right" nowrap="nowrap">Please Enter The Key Show</td>
        <td><?php
          require_once('external_resources/recaptcha-php-1.11/recaptchalib.php');
