...
<br />
<h3 id="why">انشاء حساب مستخدم</h3>
<?php
...
<div class="DataEntryView">
  <form action="<?php echo $editFormAction."?ID=users"; ?>" method="post" name="form1" id="form1">
    <table width="100%" align="center" cellpadding="5" cellspacing="5">
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><div align="left">اسم المستخدم :</div></td>
        <td><span id="sprytextfield1">
          <input name="Username" type="text" id="Username" value="" size="20" class="ac_results" autocomplete="off"/>

        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">كلمة المرور :</div></td>
        <td><span id="sprytextfield3">
        <input name="Password" type="text" id="Password" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
       </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><div align="left">الاسم كامل :</div></td>
        <td><span id="sprytextfield5">
        <input name="FullName" type="text" id="FullName" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">المجموعة :</div></td>
...
?>
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><div align="left">العنوان الاول :</div></td>
        <td><span id="sprytextfield2">
        <input name="AddressLine1" type="text" id="AddressLine1" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">العنوان الثاني :</div></td>
        <td><span id="sprytextfield4">
          <input name="AddressLine2" type="text" id="AddressLine2" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
       </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><div align="left">المدينة :</div></td>
        <td><span id="sprytextfield6">
        <input name="City" type="text" id="City" value="Riyadh" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">الدولة :</div></td>
        <td><span id="sprytextfield8">
        <input name="Country" type="text" id="Country" value="Saudi Arabia" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
       </tr>
      <tr valign="baseline">
        <td align="right" nowrap="nowrap"><div align="left">الهاتف :</div></td>
        <td><span id="sprytextfield7">
          <input name="Phone" type="text" id="Phone" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">الايميل :</div></td>
        <td><span id="sprytextfield10">
        <input name="Email" type="text" id="Email" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
       </tr>
      <tr valign="baseline">
        <td align="right" nowrap="nowrap"><div align="left">رقم التواصل :</div></td>
        <td><span id="sprytextfield9">
          <input name="ContactNo" type="text" id="ContactNo" value="" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
        <td align="right" nowrap="nowrap"><div align="left">أخرى :</div></td>
        <td><span id="sprytextfield11">
        <input name="Others" type="text" id="Others" value="N/A" size="20" />
        <span class="textfieldRequiredMsg">*</span></span></td>
       </tr>
      <tr valign="baseline">
        <td align="right" nowrap="nowrap"><div align="left">حالة الحساب :</div></td>
        <td><select name="AccountStatus" id="AccountStatus">
          <option value="1" <?php if (!(strcmp(1, 1))) {echo "SELECTED";} ?>>مفعل</option>
          <option value="0" <?php if (!(strcmp(0, 1))) {echo "SELECTED";} ?>>غير مفعل </option>
        </select></td>
  ...
  <table width="100%" align="center" cellpadding="5" cellspacing="5">
    ...
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield16">
        ...
        <span class="textfieldRequiredMsg">*</span></span></td>
      <td align="right" nowrap="nowrap"><div align="left">المجموعه :</div></td>
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap"><div align="left">رقم الهاتف :</div></td>
    ...
    <tr valign="baseline">
      ...
      <td><select name="AccountStatus">
        <option value="1" <?php if (!(strcmp(1, 1))) {echo "SELECTED";} ?>>مفعل</option>
        <option value="0" <?php if (!(strcmp(0, 1))) {echo "SELECTED";} ?>>معطل</option>
        </select></td>
      <td align="right" nowrap="nowrap"><div align="left"></div></td>
...
<div id="searchBox">
  <form id="frmSearch" name="frmSearch" method="post" action="<?php echo $currentPage."?ID=users"; ?>">
    <label for="SearchUsername">اكتب اسم المستخدم للبحث</label>
    <input type="text" name="SearchUsername" id="SearchUsername" />
    <input type="submit" name="button" id="button" value="Search" />
    (لعرض جميع النتائج ارتك المربع فارغا)
  </form>
</div>
<div class="DetailView">
  <table width="100" border="0" cellpadding="5" cellspacing="5">
    <tr class="DarkHeaderRow">
      ...
      <th width="21%">اسم المستخدم</th>
      <th width="20%">كلمة المرور</th>
      <th width="19%">اسم المجموعه</th>
      <th width="19%">الاسم كامل</th>
      <th width="17%">المدينة</th>
      <th width="17%">الايميل</th>
    </tr>
    <?php do { ?>
      <tr>
       <td><div align="center"><a href="?ID=users&Delete=true&UserID=<?php echo $row_rs_get_user_accounts['UserID']; ?>" class="action-link" onclick="return confirm('هل تريد حذف هذا الصف ؟');"><img src="images/icons/drop.gif" width="16" height="16" alt="Delete" /></a></div></td>
       <td><a href="?ID=users&amp;Edit=true&amp;SearchUsername=<?php echo $row_rs_get_user_accounts['Username']; ?>" class="action-link" onclick="return confirm('هل تريد تعديل هذا الصف ؟');"><img src="images/icons/design.gif" width="16" height="16" alt="Edit" /></a></td>
